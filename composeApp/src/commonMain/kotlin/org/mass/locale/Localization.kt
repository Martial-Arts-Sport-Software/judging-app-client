...
object Localization {
    private val strings = mapOf(
        "en" to mapOf(
            ...
            "connection_pairing_accepted" to "Device approved. Connecting securely to the server.",
            "connection_error_pairing_status_rejected" to "The operator rejected this device.",
            "connection_error_pairing_status_response_invalid" to "The server returned an invalid pairing status.",
            "connection_error_pairing_status_unavailable" to "The pairing status is unavailable.",
        ...
        "ru" to mapOf(
            ...
            "connection_pairing_accepted" to "Устройство подтверждено. Устанавливаем защищённое подключение к серверу.",
            "connection_error_pairing_status_rejected" to "Оператор отклонил это устройство.",
            "connection_error_pairing_status_response_invalid" to "Сервер вернул некорректный статус pairing.",
            "connection_error_pairing_status_unavailable" to "Статус pairing недоступен.",
